...
export default function contrattoDefinition(contratto: any): TDocumentDefinitions {
    return {
        content: [
            {
                layout: 'noBorders',
                                    ...
                                    table: {
                                        body: [
                                            [
                                                ...
                                                {
                                                    text:
                                                        contratto.contrattiSuOspite?.[0].ospite?.persona?.cognome ?? '',
                                                    bold: true,
                                                    fontSize: 10
                                                },
                                                ' Nome',
      ...
      stanza Doppia numero FB3C52`,
          ...
          Il presente verbale è redatto in due originali, dei quali uno viene consegnato all'assegnatario/a.`,
            ...
            {
                text:
                    'Ai sensi dell’art. 13 del D.Lgs. 196/2003 e dell’art. 13 del Reg. UE 2016/679 “Regolamento in materia di trattamento dei dati personali”,\nsi informa che:',
                bold: true,
                fontSize: 10
            },
            ' ',
